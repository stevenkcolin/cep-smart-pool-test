...
describe("TestForPoolToken TM1111", function () {
  this.timeout(300000);
  let signers: Signer[];
  let account: string;
  let account2: string;
  ...
  //     const balance = await pcToken.balanceOf(account);
  //     console.log("the initial balance is: ",balance.toString());
  //     expect(balance).to.eq(0);
  //   });

  //   it("Should return correct amount if account has some tokens", async () => {
  //     const mintAmount = constants.WeiPerEther.mul(5);
  //     await pcToken.mint(account, mintAmount);
  //     const balance = await pcToken.balanceOf(account);
  //     console.log("the amount of the address ",account," is: ",balance.toString());
  ...
  //     );
  //   });
  //   it("Transfer function should work", async () => {
  //     await pcToken.mint(account, constants.WeiPerEther.mul(3));
  ...
  //     console.log("the amount of address1 ",account," is: ",accountBalance.toString());
  //     console.log("the amount of address1 ",account2," is: ",account2Balance.toString());

  //     expect(accountBalance).to.eq(constants.WeiPerEther.mul(2));
